...
/* This class is used to finding the largest number in an array
*/
public class LargestNumberInAnArray {
    public static void main(String[] args) {
        int[] numberArray = {1,2,3,8,9,4};
        System.out.println("Largest Number is: "+findingLargest(numberArray));
    }
    public static int findingLargest(int[] numberArray){
