/* This class is used to find the Speed of the vehicle */
...
public class VehicleSpeedCalculation {
    public static void main(String[] args) {
        ...
        System.out.println("Vehicle Speed is: "+findingVehicleSpeed(distance,timePeriod)+"km/hr");
    }

    private static double findingVehicleSpeed(double distance, int timePeriod){
