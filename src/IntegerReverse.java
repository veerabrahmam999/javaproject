/* This class is used to reverse the integer */
public class IntegerReverse {
    public static void main(String[] args) {
        int number = 12345;
        System.out.println("Reverse Integer is: "+reverseInteger(number));
    }
    public static int reverseInteger(int number) {
        int reverseInteger=0;
        while(number!=0){
            int remainder=number%10;
             reverseInteger = remainder+(reverseInteger*10); // 5+0 4+5*10 3+540 2+5400 1+532 +54321
             number/=10;
        }
