/* This class provides the functional to generate a random password */
...
public class RandomPasswordGenerator {
    public static void main(String[] args) {
        while(true) {
            String allCharacters = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz!@#$%^&*()_+:><?}{";
            generatingRandomPassword(allCharacters);
            Scanner scanner = new Scanner(System.in);
            System.out.print("Do you want generate Random Password Again(Yes/No): ");
    ...
    private static void generatingRandomPassword(String allCharacters) {
        StringBuilder randomPassword = new StringBuilder();
        Random random = new Random();
        for (int i = 0; i < 10; i++){
            randomPassword.append(allCharacters.charAt(random.nextInt(allCharacters.length())));
    }
