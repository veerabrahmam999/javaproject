/* This class used to find the current Age of a Person*/
...
public class CurrentAgeCalculator{
    public static void main(String[] args) {
        ...
        System.out.print("Enter Born Month: ");
        int bornMonth = scanner.nextInt();

        System.out.print("Enter Born Date: ");
        int bornDate = scanner.nextInt();


        System.out.println(findingCurrentAge(bornYear,bornMonth,bornDate));

    }
    private static Period findingCurrentAge(int bornYear, int bornMonth, int bornDate){
        LocalDate currentDate = LocalDate.now();
        LocalDate dob = LocalDate.of(bornYear,bornMonth,bornDate);

        Period period = Period.between(currentDate,dob);
