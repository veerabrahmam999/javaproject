...
/* This Class is used to convert Litres Into Milli-Litres */

import java.util.Scanner;

public class MilliLitresCalculator {


    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        System.out.print("Enter the number of Litres: ");
        double litres = scanner.nextDouble();
        System.out.println("Milli-Litres Are: "+litresIntoMilliLitres(litres));
    }
    private static double litresIntoMilliLitres(double litres){
        return litres*1000;
