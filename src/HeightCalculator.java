/*This class used to Calculate height
...
public class HeightCalculator {
    public static void main(String[] args) {
        ...
        double noOfFeets=scanner.nextDouble();

        System.out.print("Enter the Height in Inches: ");
        double noOfInches = scanner.nextDouble();

        System.out.println("Feets To Centimeters are: "+feetsIntoCentimeters(noOfFeets));

        System.out.println("Inches to Centimeters are: "+InchesIntoCentimeters(noOfInches));
    }
    private static double feetsIntoCentimeters( double noOfFeets){
        return noOfFeets*30.48;

    }
    private static double InchesIntoCentimeters(double noOfInches){
        return noOfInches*2.5;
    }
}
