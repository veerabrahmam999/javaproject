...
/* This class is used to find the given letter is
     vowel or constant
 */
public class VowelOrConstant {
    public static void main(String[] args) {
        ...
        findingVowelOrConstant(character);

    }

    static void findingVowelOrConstant(char character) {
        if(character=='a'|| character=='e'|| character =='i'|| character=='o'||character=='u'){
            System.out.println(character+" is vowel.");
        }
        else{
            System.out.println(character+" not a vowel.");
        }
    }
}
