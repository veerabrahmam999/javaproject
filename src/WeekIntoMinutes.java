/*This class provides the functionality to convert week into minutes
*/
public class WeekIntoMinutes {
    public static void main(String[] args) {
        System.out.println("Minutes in a week are: "+findingMinutes());

    }
    private static long findingMinutes(){
        return 7*24*60;
    }
}
