/* This class is used to return first and last elements in a list */
...
public class FirstAndLastElements {
    public static void main(String[] args) {
        ...
        list.add(400);
        list.add(500);
        findingFirstAndLast(list);
    }
    private static void findingFirstAndLast(List<Integer> list){

        List<Integer> firstAndLast= new ArrayList<>();

        firstAndLast.add(list.getFirst());
        firstAndLast.add(list.getLast());

        System.out.println("First and Last Elements are: "+firstAndLast);
    }
}
