/* This class is used to finding the smallest number in an array
 */
public class SmallestNumberInAnArray {
    public static void main(String[] args) {
        int[] numberArray = {1,2,3,8,9,4};
        System.out.println("Smallest Number is: "+findingSmallest(numberArray));
    }
    public static int findingSmallest(int[] numberArray){
