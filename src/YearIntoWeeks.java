/* This class used to convert Year into Weeks*/

public class YearIntoWeeks {
    public static void main(String[] args) {
        System.out.println("Number of Weeks In a Year is: "+findingWeeks());

    }
    private static int findingWeeks(){
        return Math.round(365/7);
    }
}
