/*This class used to convert Kilometers into meters */

import java.util.Scanner;

public class KilometersIntoMeters {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        System.out.print("Enter the Kilometers: ");
        double kilometers = scanner.nextDouble();
        System.out.println("Meters are: "+convertingIntoMeters(kilometers));


    }
    private static double convertingIntoMeters(double kilometers){
