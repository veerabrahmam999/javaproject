...
/*This Class is used to swap the variables */
import java.util.Arrays;
import java.util.Scanner;


public class VariablesSwapping {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        System.out.print("Enter the Variable1 value: ");
        int variable1= scanner.nextInt();
        System.out.print("Enter the Variable2 value: ");
        int variable2 = scanner.nextInt();
        System.out.print("After Swapping");
        System.out.println(Arrays.toString(swappingVariables(variable1, variable2)));
    }




    public static int[] swappingVariables(int variable1, int variable2) {
