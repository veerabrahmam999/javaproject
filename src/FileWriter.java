/*This class is used to put the data in a file by using coding */
...
public class FileWriter {
    public static void main(String[] args) throws IOException {
        try{
        java.io.FileWriter fileLocation = new java.io.FileWriter("C:\\word\\writer.txt");
        try {
            fileLocation.write("Hii hello Good Morning");
            fileLocation.write("Have you done your tiffen?");
        }finally {
            fileLocation.close();
        }
