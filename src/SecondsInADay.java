/* This class is used to find the number of Seconds in a day */


public class SecondsInADay {
    public static void main(String[] args) {
        int day =1;
        System.out.println("Number of Seconds In a Day Are: "+SecondsInADay.findingSeconds(day));
    }
    private static long findingSeconds(int day){
