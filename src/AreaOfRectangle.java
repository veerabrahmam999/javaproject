/* This class provides the funcionality for calculating
...
public class AreaOfRectangle {
    public static void main(String[] args) {
        ...
        System.out.println("Area of Rectangle: "+CalculatingArea(length,breadth));

    }

    private static double CalculatingArea(double length,double breadth){
