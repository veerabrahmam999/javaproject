/* This class used to calculate the Interest for loan Amount */


import java.util.Scanner;

public class InterestAmountCalculation {
    public static void main(String[] args) {
        ...
        System.out.println("Intrest Amount is:"+findingIntrest(loanAmount,rateOfInterest,timePeriod));
    }

    private static double findingIntrest(double loanAmount, double rateOfInterest, int timePeriod){

        double interestAmount = (loanAmount*rateOfInterest*timePeriod)/100;
