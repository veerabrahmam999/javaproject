...
/* This class provides the functionality to find in which year
  the given person will get the 100 years age.
 */
public class AgeCalculator {
    public static void main(String[] args) {
        ...
        int hundredYear=gettingHundredYears(currentAge);
        System.out.println(personName+" will get hundred years in "+hundredYear);
    }
    private static int gettingHundredYears( int currentAge){
        int ageDifference=100-currentAge;


        return LocalDate.now().getYear()+ageDifference;
    }
}
