/* This class used to provide to calculate whether the person is
...
public class SeniorCitizenCalculator {
    public static void main(String[] args) {
        ...
        SeniorCitizenCalculator seniorCitizen = new SeniorCitizenCalculator();
        seniorCitizen.CalculatingAge(personAge);
    }
    private void CalculatingAge(int personAge){
