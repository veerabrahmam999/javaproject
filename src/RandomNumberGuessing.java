/* This class is used to generate a random number and
 tells to user whether he guessed the correct random number or not
 */
...
public class RandomNumberGuessing {
    public static void main(String[] args) {
        ...
        guessingNumber(guessNumber,randomNumber);

    }
    private static void guessingNumber(int guessNumber, int randomNumber){


        if(guessNumber==randomNumber){
            System.out.println("Guessed Correct Number.");
        }
        else if(guessNumber>randomNumber){
            System.out.println("Guessed High Number.");
        }
        else{
            System.out.println("Guessed Low Number.");
        }
