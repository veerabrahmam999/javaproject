/* This class is used to calculate the perimeter of a traiangle */
...
public class PerimeterOfTriangle {
    public static void main(String[] args) {
        ...
        System.out.print("Enter the Side1 value: ");
        int side1=scanner.nextInt();
        System.out.print("Enter the Side2 value: ");
        int side2 = scanner.nextInt();
        System.out.print("Enter the side3 value: ");
        int side3 = scanner.nextInt();
        System.out.println("perimeter of a triangle: "+calculatePerimeter(side1,side2,side3));
